[![All dependencies](https://img.shields.io/librariesio/release/npm/xlsx-column/2.2.1?style=flat-square "All dependencies of xlsx-column@2.2.1")](https://libraries.io/npm/xlsx-column/2.2.1)
